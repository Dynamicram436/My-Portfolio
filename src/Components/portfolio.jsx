...
const Portfolio = () => {
      ...
      <div className={baseClasses + " " + colorClasses[project.color]}>
        ...
        <div className="p-4 sm:p-5 lg:p-6">
          <div className="mb-4 sm:mb-5">
            <h3 className={`text-base sm:text-lg lg:text-xl font-bold mb-2 sm:mb-3 group-hover:transition-colors duration-300 ${
              project.dark ? "text-white group-hover:text-green-300" : "text-gray-800 group-hover:text-emerald-600"
            }`}>
              {project.title}
            </h3>
            <p className={`${project.dark ? "text-gray-300" : "text-gray-600"} text-sm sm:text-base leading-relaxed`}>
              {project.description}
            </p>
          </div>
          ...
          <div className="flex flex-col sm:flex-row gap-3">
            <a
              ...
              className={`flex-1 group/btn relative overflow-hidden bg-gradient-to-r text-white font-semibold py-2 sm:py-3 px-4 sm:px-6 rounded-lg sm:rounded-xl transition-all duration-300 hover:shadow-lg hover:scale-105 text-center ${
  ...
  return (
    <div className="bg-gradient-to-br from-amber-50 via-orange-50 to-red-50 min-h-screen relative overflow-x-hidden text-gray-900">
      ...
      {/* Projects Section */}
      <section className="py-12 sm:py-16 lg:py-20 relative overflow-hidden bg-gradient-to-b from-amber-50 via-orange-50 to-red-50" id="projects">
        <div className="container max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 relative">
          <div className="text-center mb-8 sm:mb-12 lg:mb-16">
            <div className="inline-block">
              <h2 className="text-3xl sm:text-4xl lg:text-5xl xl:text-6xl font-black text-transparent bg-clip-text bg-gradient-to-r from-gray-900 via-emerald-600 to-amber-600 mb-4 sm:mb-6 tracking-tight">
                Featured
                <span className="block bg-gradient-to-r from-emerald-600 via-amber-600 to-rose-600 bg-clip-text text-transparent">
                  Projects
                </span>
              </h2>
              <div className="w-24 sm:w-32 h-1 sm:h-1.5 bg-gradient-to-r from-emerald-500 via-amber-500 to-rose-500 mx-auto rounded-full shadow-lg shadow-emerald-500/40"></div>
            </div>
            <p className="text-gray-700 text-base sm:text-lg lg:text-xl mt-6 sm:mt-8 max-w-3xl mx-auto leading-relaxed">
