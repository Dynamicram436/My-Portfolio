...
const experience = [
  ...
  },
  {
    ...
    description:
      "Developed an admin dashboard for vendors to access their productivity metrics as a front-end developer.Enabled vendors to view their productivity details and allowed customers to check their performance.Designed the application using ReactJS, React Charts, and Recharts, and conducted API testing in Postman.",
  ...
  },
  {
    ...
    description:
      "Developed a learning management system platform for college students.\nEnabled students to access learning resources, take exams, and check results.\nUtilized the MERN stack, Recharts for performance display, and MongoDB for data storage.",
...
const Portfolio = () => {
  ...
  const SkillIcon = ({ skill }) => {
    ...
    const icons = {
      html: (
        <svg
          viewBox="0 0 128 128"
          className="w-12 h-12 sm:w-14 sm:h-14 mx-auto mb-3 drop-shadow-lg"
        >
          <path
            fill="#E44D26"
  ...
  const ProjectCard = ({ project }) => {
    return (
      <div className="group relative bg-slate-900/50 backdrop-blur-xl rounded-2xl sm:rounded-3xl overflow-hidden border border-slate-700/50 transition-all duration-500 hover:border-violet-500/50 hover:shadow-[0_0_40px_rgba(139,92,246,0.2)] hover:-translate-y-2 h-full flex flex-col">
        ...
        <div className="p-5 sm:p-6 flex flex-col flex-grow relative">
          ...
          <div className="flex flex-wrap gap-2 mb-4">
            {project.tech.map((tech, i) => (
              <span
                key={i}
                className="px-2.5 py-1 bg-slate-800/80 text-slate-300 text-xs font-medium rounded-lg border border-slate-700/50"
              >
                {tech}
              </span>
            ))}
  ...
  return (
    <div className="bg-slate-950 min-h-screen relative overflow-x-hidden text-slate-100">
          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            ...
            <div className="space-y-6 order-1 lg:order-2" data-aos="fade-left">
              <p className="text-lg sm:text-xl text-slate-300 leading-relaxed">
                ...
                of hands-on experience developing web applications with modern
                technologies.
              </p>
          ...
          <div className="relative">
            ...
            {experience.map((job, index) => (
              ...
              >
                ...
                <div
                  className={`sm:pl-12 ${index % 2 === 0 ? "md:pr-12 md:pl-0" : "md:pl-12"}`}
                >
      ...
      <footer
        id="contact"
        className="py-24 lg:py-32 relative border-t border-slate-800/50"
      >
        <div className="container max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="bg-slate-900/50 backdrop-blur-sm rounded-2xl p-6 border border-slate-800">
              ...
              <div className="space-y-3">
                ...
                <a
                  ...
                  className="flex items-center gap-2 text-slate-400 hover:text-cyan-400 transition-colors text-sm break-all"
                >
                  <svg
                    className="w-4 h-4"
                    fill="none"
          ...
          <div className="mt-16 pt-8 border-t border-slate-800/50 text-center">
            <p className="text-slate-500 text-sm">
              © 2024 Bhargav Ram. All rights reserved. Built with ❤️ using React
              & Tailwind CSS.
            </p>
          </div>
        </div>
